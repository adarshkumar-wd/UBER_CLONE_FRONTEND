  ...
  return (
    <div>
         <div className="flex w-full justify-between items-center px-3">
            ...
            <div onClick={() => props.setVechilePanel(false)} className="text-2xl font-bold"><i className="ri-arrow-down-s-line"></i></div>
         </div>

          <div onClick={() => {
            props.setConfirmRidePanel(true);
            props.setVechilePanel(false)
          }} className="w-full flex items-center justify-between px-2 py-4 border-2 active:border-black rounded-xl mb-3">
